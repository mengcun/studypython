...
workspace = join(home_root, 'studypython/identify_code/TensorFlow_CNN/crack/my_code_data')  # 用于工作的训练数据集
model_path = join(home_root, 'studypython/identify_code/TensorFlow_CNN/crack/model')

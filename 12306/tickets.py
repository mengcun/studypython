...
Example:
    #查询5月10日北京到上海所有车次
    python tickets.py 北京 上海 2018-03-10 
    #查询5月10日南京到上海的动车和高铁
    python tickets.py -dg 南京 上海 2018-03-10

Attation:一定注意Usage 和 docopt配合使用时候Usage的格式问题！
"""
